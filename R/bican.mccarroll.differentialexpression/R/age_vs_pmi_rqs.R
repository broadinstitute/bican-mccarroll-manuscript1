...
plot_effect_comparison_page <- function(age,
                                        pmi,
                                        rqs,
                                        cell_type_value,
                                        region_value) {
...
plot_effect_comparison <- function(x,
                                   y,
                                   x_label,
                                   y_label,
                                   cell_type_value,
...
write_effect_comparison_pdf <- function(age,
                                        pmi,
                                        rqs,
...
plot_age_model_comparison_page <- function(full_model_de,
                                           partial_model_de,
                                           cell_type_value,
                                           tested_trait = "RQS") {
  # Make R CMD CHECK happy
...
write_age_model_comparison_pdf <- function(tested_trait = "RQS",
                                           full_model_de,
                                           partial_model_de,
...
summarize_model_differences <- function(full_model_de,
                                        partial_model_de) {
  # Make R CMD CHECK happy
