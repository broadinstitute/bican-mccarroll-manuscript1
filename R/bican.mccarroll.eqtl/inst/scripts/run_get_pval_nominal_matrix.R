## ============================================================
## Task: Build pval_nominal matrix for eGene-variant pairs
## ============================================================
...
output_path <- "/broad/bican_um1_mccarroll/RNAseq/analysis/CAP_freeze_3_analysis/eqtls/manuscript_data/pval_nominal_matrix_qval_0.01.tsv"
